...
youtubedl.exec(url, ['-x', '--audio-format', 'wav', '-o', 'audio.%(ext)s', '--postprocessor-args', '-filter_complex "lv2=plugin=https\\://github.com/lucianodato/speech-denoiser"'], {}, async function(err, output) {
if (err) throw err
